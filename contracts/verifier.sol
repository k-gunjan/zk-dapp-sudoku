...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 5660315475052121724098070731985009995267136842559755545969138786517579717954;
    uint256 constant Qmy  = 17117204041921026835890541074440427815687476607052101468703120547423067376666;
    uint256 constant Qlx  = 14970313875316517584747321273755407679751064424561012976861249467320938570368;
    uint256 constant Qly  = 12337390684293977119727485566425699883375214894609486115882526242969364655343;
    uint256 constant Qrx  = 18331346370495743068352349690971066894397468625176899172822337584925076280907;
    uint256 constant Qry  = 946461039177954007298920501307362632180595437175041966939086860896805635398;
    uint256 constant Qox  = 3529029183533690781975502351062524983109675063071838528041874677166782355465;
    uint256 constant Qoy  = 20160366811879416287572009365683266102867631516037963548408462205582814710465;
    uint256 constant Qcx  = 2655516638683678433276045325592371517916576921253575918519027848950362269657;
    uint256 constant Qcy  = 6370987623927267777379888449523367665533963066175530666010940313883148642094;
    uint256 constant S1x  = 19691600734188436083914386309304946480884702233807946723706980567725807525958;
    uint256 constant S1y  = 17260948242287198446696376425699765934772391398022652800288605588184909107353;
    uint256 constant S2x  = 2756478519177150145148453064239483041130160156645635670200203165866987967908;
    uint256 constant S2y  = 7299268831848184995363294239306763208769916632071164438253484917384675705491;
    uint256 constant S3x  = 17421343297843814134643577405342432882810558660441670120237171420993650570689;
    uint256 constant S3y  = 4018011661760274185846041038809032781633631353568657561784909505066812417593;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 8686667881826454929131898851244006765549539867823823977273827834983467530983;
    uint256 constant X2x2 = 21485888153079954816947699367501474788855910945225819611194044718248716625147;
    uint256 constant X2y1 = 10127321041985551592045681622298090987499468227828641386817279847102592481005;
    uint256 constant X2y2 = 8733468748152886702817256163530858203997010005122141818199345347166397318706;
    ...
    uint16 constant lastMem = 3392;

    function verifyProof(uint256[24] calldata _proof, uint256[81] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 3104 ), calldataload(pA))
                mstore(add(mIn, 3136 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 3168 ), calldataload(pB))
                mstore(add(mIn, 3200 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 3232 ), calldataload(pC))
                mstore(add(mIn, 3264 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 3296), q) 
